...
export default function EditProduct({ product }: ProductEditProps) {
    ...
    function getVariantOptionMenu() {
        ...
        (data.variants as ProductVariant[]).forEach((variant, idx) => {
            ...
            const option1 = variant.option1_name && variant.option1_value ? `${variant.option1_name}: ${variant.option1_value}` : null;
            const option2 = variant.option2_name && variant.option2_value ? `${variant.option2_name}: ${variant.option2_value}` : null;
            const option3 = variant.option3_name && variant.option3_value ? `${variant.option3_name}: ${variant.option3_value}` : null;
        ...
        <AppLayout>
            <Card className="mx-auto w-full max-w-4xl">
                <CardHeader>
                    ...
                    <CardDescription>Update product information. Changes will be saved immediately upon clicking save.</CardDescription>
                    <div className="mt-4">
                ...
                <form onSubmit={handleSubmit}>
                    <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label className="mb-1 block text-xs font-medium">Published</label>
                            <input
                                type="checkbox"
                                name="published"
                    ...
                    <CardContent>
                        ...
                        <div className="mt-6 md:col-span-2">
                            <label className="mb-1 block text-xs font-medium">Add New Images</label>
                            <p className={'text-white/70'}>
                                Select multiple images then select the corresponding option/category from existing variants.
                            </p>
                            <Input
                                type="file"
                                multiple
                ...
                {successMessage && <div className="flex text-green-700">{successMessage}</div>}
            </Card>
        </AppLayout>
    );
}
