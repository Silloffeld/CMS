        ...
        <AppLayout>
            {(!product || !customer || !inventory) && showModal ? (
                ...
                <div className={'flex flex-col'}>
                    ...
                    <div className={'m-2 bg-secondary rounded'}>
                    <button className={"bg-secondary w-full bg-radial text-xl mb-0 underline p-2 rounded-t text-left hover:to-95% hover:from-white/20"}
